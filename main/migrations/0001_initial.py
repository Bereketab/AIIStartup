    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_sector', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.ImageField(upload_to='user_pic/%Y/%m/%d', validators=[main.utils.validate_image], verbose_name='Profile Picture')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='message_sender_user', to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('service', models.CharField(choices=[('Accelerator', 'Accelerator'), ('Incubation', 'Incubation'), ('Hub', 'Hub')], max_length=50, verbose_name='Service')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('GOVERNMENT_TYPE', models.CharField(choices=[('ministry_offices', 'Ministry offices'), ('universities', 'Universities'), ('Other', 'Other')], max_length=50, verbose_name='Government type')),
                ('GOVERNMENT_TYPE_other', models.CharField(max_length=50)),
                ('level', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=500), default=list, size=20)),
                ('address', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='Government_address', to='main.address')),
                ('description', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='Government_description', to='main.description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('donor_type', models.CharField(choices=[('self_', 'self'), ('government', 'government'), ('nGO', 'NGO'), ('grant', 'Grant'), ('International', 'International'), ('Other', 'Other')], max_length=50, verbose_name='Donor Type')),
                ('donor_type_by_other', models.CharField(blank=True, max_length=50, null=True)),
                ('level', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=500), default=list, size=20, verbose_name='Level')),
                ...
                ('max_investment_range', models.CharField(blank=True, max_length=100, null=True, verbose_name='Investment Range')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_admin', models.IntegerField(choices=[(1, 'Pending'), (2, 'Accepted'), (3, 'Rejected')], default=1)),
        ...
        migrations.AddField(
            model_name='address',
            name='location',
            field=models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='main.wereda', verbose_name='Wereda'),
        ),
    ]
